...
export class Token extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gitea:index/token:Token';
    ...
    declare public /*out*/ readonly lastEight: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: TokenArgs | TokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["lastEight"] = state?.lastEight;
