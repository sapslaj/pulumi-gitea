...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gitea");
			params.setVersion("0.7.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2dvLWdpdGVhL2dpdGVhIiwidmVyc2lvbiI6IjAuNy4wIn19"), c => c.charCodeAt(0)));
